			...
			<div class="tab-pane active" id="tab_2">
				<div class="portlet box green">
					...
					<div class="portlet-body form">
						<!-- BEGIN FORM-->
						<form action="<?php echo $root; ?>dashboard/add_causes" method="post"  enctype="multipart/form-data" id="upload">
							...
							<div class="form-body">
								...
								<div class="form-group ">
									...
									<br />
									<textarea cols="75" rows="10" name="lgdescription" class="form-control"></textarea>
