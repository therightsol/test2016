...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/extra_pricing_table.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:50:46 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Save a soul | Extra - Pricing Tables</title>
							...
							<div class="row">
								<div class="col-md-3">
									<div class="pricing-table">
										...
										<ul>
											<li>
												<i class="fa fa-angle-right"></i> 10 Email Accounts
											</li>
											<li>
												<i class="fa fa-angle-right"></i> 10 User Accounts
											</li>
											<li>
												<i class="fa fa-angle-right"></i> 100 GB Storage
											</li>
											<li>
												<i class="fa fa-angle-right"></i> 24X7 Support
											</li>
											<li>
												&nbsp;
											</li>
								...
								<div class="col-md-3">
									<div class="pricing-table">
										...
										<ul>
											<li>
												<i class="fa fa-angle-right"></i> 100 Email Accounts
											</li>
											<li>
												<i class="fa fa-angle-right"></i> 100 User Accounts
											</li>
											<li>
												<i class="fa fa-angle-right"></i> 1 TB Storage
											</li>
											<li>
												<i class="fa fa-angle-right"></i> 24X7 Support
											</li>
											<li>
												<i class="fa fa-angle-right"></i> Full Backup
											</li>
											<li>
												<i class="fa fa-angle-right"></i> Free Setup
											</li>
											<li>
												&nbsp;
											</li>
								...
								<div class="col-md-3">
									<div class="pricing-table selected">
										...
										<ul>
											<li>
												<i class="fa fa-angle-right"></i> Unlimited Email Accounts
											</li>
											<li>
												<i class="fa fa-angle-right"></i> Unlimited User Accounts
											</li>
											<li>
												<i class="fa fa-angle-right"></i> 10 TB Storage
											</li>
											<li>
												<i class="fa fa-angle-right"></i> 24X7 Support
											</li>
											...
											<li>
												<i class="fa fa-angle-right"></i> Free CDN
											</li>
										</ul>
										<div class="rate">
											<div class="price">
								...
								<div class="col-md-3">
									<div class="pricing-table">
										...
										<ul>
											...
											<li>
												<i class="fa fa-angle-right"></i> Unlimited Storage
											</li>
											<li>
												<i class="fa fa-angle-right"></i> 24X7 Support
											</li>
