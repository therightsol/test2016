...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/form_editable.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:47:48 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Save a soul | Form Stuff - Form X-editable</title>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<tr>
						...
						<td>
							<span class="text-muted">
								Select, loaded from js array. Custom display
							</span>
						</td>
					</tr>
					<tr>
						...
						<td>
							<span class="text-muted">
								Select, loaded from server. <strong>No buttons</strong> mode
							</span>
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							<a href="#" id="meeting_start" data-type="datetime" data-pk="1" data-url="/post" data-placement="right" title="Set date & time">15/03/2013 12:45</a>
						</td>
						<td>
							<span class="text-muted">
								Bootstrap datetime
					...
					<tr>
						...
						<td>
							<a href="#" id="comments" data-type="textarea" data-pk="1" data-placeholder="Your comments here..." data-original-title="Enter comments">awesome<br>
							user!</a>
						</td>
						<td>
							<span class="text-muted">
					...
					<tr>
						...
						<td>
							<a href="#" id="state" data-type="typeahead" data-pk="1" data-placement="right" data-original-title="Start typing State.."></a>
						</td>
						<td>
							<span class="text-muted">
								Bootstrap typeahead
					...
					<tr>
						...
						<td>
							<a href="#" id="tags" data-type="select2" data-pk="1" data-original-title="Enter tags">html, javascript</a>
						</td>
						<td>
							<span class="text-muted">
								Select2 (tags mode)
					...
					<tr>
						...
						<td>
							<a href="#" id="country" data-type="select2" data-pk="1" data-value="BS" data-original-title="Select country"></a>
						</td>
						<td>
							<span class="text-muted">
					...
					<tr>
						...
						<td>
							<span class="text-muted">
								Your custom input, several fields
							</span>
						</td>
					</tr>
					<tr>
						...
						<td>
							<a href="#" id="pencil"><i class="fa fa-pencil"></i> [edit]</a><br>
							<span class="text-muted">
...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/form_editable.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:47:54 GMT -->
</html>