...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/form_image_crop.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:48:00 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Save a soul | Form Stuff - Image Cropping</title>
				...
				<div class="col-md-12">
					<div class="tabbable tabbable-custom boxless">
						<ul class="nav nav-tabs">
							<li class="active">
								<a href="#tab_1" data-toggle="tab">Default Behavior</a>
							</li>
							<li>
							...
							<li>
								<a href="#tab_7" data-toggle="tab">Non-Image Elements</a>
							</li>
							<li>
								<a href="#tab_8" data-toggle="tab">PHP Cropping Demo</a>
							</li>
						</ul>
						<div class="tab-content">
							<div class="tab-pane active" id="tab_1">
								...
								<img src="assets/plugins/jcrop/demos/demo_files/image1.jpg" id="demo1" alt="Jcrop Example" class="img-responsive"/>
							</div>
							<div class="tab-pane" id="tab_2">
								<div class="row">
									<div class="col-md-7 col-sm-12 responsive-1024">
										...
										<img src="assets/plugins/jcrop/demos/demo_files/image2.jpg" id="demo2" alt="Jcrop Example" class="img-responsive"/>
									</div>
									...
									<div class="col-md-7 responsive-1024">
										...
										<div>
											<h4>Animation/Transitions.</h4>
											 Demonstration of animateTo API method and transitions for bgColor and bgOpacity options. Color fading requires inclusion of John Resig's jQuery <a href="http://plugins.jquery.com/project/color">Color Animations</a> plugin. If it is not included, colors will not fade.
										</div>
									</div>
							...
							<div class="tab-pane" id="tab_8">
								<div class="row">
									...
									<div class="col-md-5 responsive-1024">
										...
										<form action="http://www.keenthemes.com/preview/metronic_admin/assets/plugins/jcrop/crop-demo.php" target="_blank" method="post" id="demo8_form">
...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/form_image_crop.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:48:39 GMT -->
</html>