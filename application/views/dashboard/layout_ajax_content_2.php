...
<div class="row">
	<div class="col-md-6">
					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="radio-list">
								...
								<label>
								<input type="radio" name="optionsRadios" id="optionsRadios2" value="option3" disabled> Disabled </label>
							</div>
						</div>
						<div class="form-group">
		...
		<div class="portlet box purple">
			<div class="portlet-title">
				<div class="caption">
					<i class="fa fa-reorder"></i> Input Groups
				</div>
				<div class="tools">
					<a href="#" class="collapse"></a>
					<a href="#portlet-config" data-toggle="modal" class="config"></a>
			...
			<div class="portlet-body form">
				<form class="form-horizontal" role="form">
					<div class="form-body">
						...
						<div class="form-group">
							<label class="col-lg-3 control-label">Left Icon</label>
							<div class="col-lg-9">
								<div class="input-icon">
									<i class="fa fa-bell-o"></i>
									<input type="text" class="form-control" placeholder="Left icon">
						...
						<div class="form-group">
							<label class="col-lg-3 control-label">Right Icon</label>
							<div class="col-lg-9">
								<div class="input-icon right">
									<i class="fa fa-microphone"></i>
									<input type="text" class="form-control" placeholder="Right icon">
						...
						<div class="form-group">
							<label class="col-lg-3 control-label">Input With Spinner</label>
							<div class="col-lg-9">
								<input type="password" class="form-control spinner" placeholder="Password">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-3 control-label">Static Control</label>
							<div class="col-lg-9">
								<p class="form-control-static">
									 email@example.com
								</p>
						...
						<div class="form-group">
							<label class="col-lg-3 control-label">Readonly</label>
							<div class="col-lg-9">
								<input type="password" class="form-control" placeholder="Readonly" readonly>
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-3 control-label">Dropdown</label>
							<div class="col-lg-9">
								<select class="form-control">
									<option>Option 1</option>
									<option>Option 2</option>
						...
						<div class="form-group">
							<label class="col-lg-3 control-label">Multiple Select</label>
							<div class="col-lg-9">
								<select multiple class="form-control">
									<option>Option 1</option>
									<option>Option 2</option>
						...
						<div class="form-group">
							<label class="col-lg-3 control-label">Textarea</label>
							<div class="col-lg-9">
								<textarea class="form-control" rows="3"></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="exampleInputFile" class="col-lg-3 control-label">File input</label>
							<div class="col-lg-9">
								<input type="file" id="exampleInputFile">
								<p class="help-block">
									 some help text here.
						...
						<div class="form-group">
							...
							<div class="col-lg-9">
								<div class="radio-list">
									...
									<input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" checked> Option 1 </label>
									<label>
									<input type="radio" name="optionsRadios" id="optionsRadios2" value="option2" checked> Option 2 </label>
									<label>
									<input type="radio" name="optionsRadios" id="optionsRadios2" value="option2" disabled> Disabled </label>
								</div>
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-3 control-label">Inline Radio</label>
							<div class="col-lg-9">
								<div class="radio-list">
									<label class="radio-inline">
									<input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" checked> Option 1 </label>
		...
		<div class="portlet box purple">
			...
			<div class="portlet-body form">
				<form class="form-horizontal" role="form">
					<div class="form-body">
						<div class="form-group">
							<label class="col-lg-3 control-label">Large Input</label>
							<div class="col-lg-9">
								<input type="text" class="form-control input-lg" placeholder="Large Input">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-3 control-label">Default Input</label>
							<div class="col-lg-9">
								<input type="text" class="form-control" placeholder="Default Input">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-3 control-label">Small Input</label>
							<div class="col-lg-9">
								<input type="text" class="form-control input-sm" placeholder="Default Input">
							</div>
						</div>
						<div class="form-group">
							<label class="col-lg-3 control-label">Large Select</label>
							<div class="col-lg-9">
								<select class="form-control input-lg">
									<option>Option 1</option>
									<option>Option 2</option>
						...
						<div class="form-group">
							<label class="col-lg-3 control-label">Default Select</label>
							<div class="col-lg-9">
								<select class="form-control">
									<option>Option 1</option>
									<option>Option 2</option>
						...
						<div class="form-group">
							<label class="col-lg-3 control-label">Small Select</label>
							<div class="col-lg-9">
								<select class="form-control input-sm">
									<option>Option 1</option>
									<option>Option 2</option>
		...
		<div class="portlet box purple">
			...
			<div class="portlet-body form">
				<form role="form" class="form-horizontal">
					<div class="form-body">
						<div class="form-group">
							<label class="col-lg-3 control-label" for="inputSuccess">Default input</label>
							<div class="col-lg-9">
								<div class="input-icon right">
									<i class="fa fa-info-circle tooltips" data-original-title="Email address"></i>
									<input type="text" class="form-control">
						...
						<div class="form-group has-success">
							<label class="col-lg-3 control-label" for="inputSuccess">Input with success</label>
							<div class="col-lg-9">
								<div class="input-icon right">
									<i class="fa fa-check tooltips" data-original-title="You look OK!"></i>
									<input type="text" class="form-control">
						...
						<div class="form-group has-warning">
							<label class="col-lg-3 control-label" for="inputWarning">Input with warning</label>
							<div class="col-lg-9">
								<div class="input-icon right">
									<i class="fa fa-warning tooltips" data-original-title="please provide an email"></i>
									<input type="text" class="form-control">
						...
						<div class="form-group has-error">
							<label class="col-lg-3 control-label" for="inputError">Input with error</label>
							<div class="col-lg-9">
								<div class="input-icon right">
									<i class="fa fa-exclamation tooltips" data-original-title="please write a valid email"></i>
									<input type="text" class="form-control">
