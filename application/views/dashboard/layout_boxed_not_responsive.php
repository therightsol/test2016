...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/layout_boxed_not_responsive.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:45:33 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Save a soul | Layouts - Non-Responsive Boxed Layout</title>
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<ul class="page-breadcrumb breadcrumb">
							...
							<li>
								<a href="#">Non-Responsive Boxed Layout</a>
							</li>
						</ul>
				...
				<div class="row">
					<div class="col-xs-12">
						<div class="note note-success">
							<h4 class="block">Disabling responsiveness</h4>
							<p>
								 For grid layouts, make use of .col-xs-* classes in addition to or in place of the medium/large ones. Don't worry, the extra-small device grid scales up to all resolutions, so you're set there. For more info visit <a href="http://getbootstrap.com/getting-started/#disable-responsive">http://getbootstrap.com/getting-started/#disable-responsive</a>
							</p>
						</div>
					</div>
				</div>
...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/layout_boxed_not_responsive.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:45:34 GMT -->
</html>