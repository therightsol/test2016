...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/layout_disabled_menu.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:45:33 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Save a soul | Layouts - Disabled Menu Links</title>
	...
	<div class="header-inner">
		...
		<div class="hor-menu hidden-sm hidden-xs">
			<ul class="nav navbar-nav">
				...
				<li>
					<a data-toggle="dropdown" data-hover="dropdown" data-close-others="true" href="#">Extra <i class="fa fa-angle-down"></i>
					</a>
					<ul class="dropdown-menu">
						<li>
			...
			<ul class="page-sidebar-menu">
				...
				<li class="start active">
					...
					<ul class="sub-menu">
						...
						<li class="disabled-link tooltips" data-original-title="Please login to access here">
							<a href="#">
							<span class="text">
				...
				<li class="disabled-link">
					...
					<ul class="sub-menu">
						...
						<li class="disabled-link">
							<a href="portlet_general.html">
							<span class="text">
								<i class="fa fa-user"></i> Disabled Link With Icon
							</span>
							</a>
						</li>
					</ul>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="note note-success">
				<h4 class="block">Disabled Menu Links</h4>
				<p>
					 To change the disabled menu link style please go to <code>ssets/css/style.css</code> and find <code>Disabled Menu Link</code> comment section.
				</p>
			</div>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
