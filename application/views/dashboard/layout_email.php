...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/layout_email.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:46:24 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Save a soul | Layouts - Email Templates</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="mail-template clearfix">
						<h4>Marketing Email Templates</h4>
						<ul class="list-unstyled">
							<li class="color-black tooltips" data-original-title="Click to preview the template">
								<a href="email1.html" target="_blank">&nbsp;</a>
							</li>
							<li class="color-darkblue tooltips" data-original-title="Click to preview the template">
								<a href="email2.html" target="_blank">&nbsp;</a>
							</li>
							<li class="color-lightblue tooltips" data-original-title="Click to preview the template">
								<a href="email3.html" target="_blank">&nbsp;</a>
							</li>
							<li class="color-red tooltips" data-original-title="Click to preview the template">
								<a href="email4.html" target="_blank">&nbsp;</a>
							</li>
							<li class="color-green tooltips" data-original-title="Click to preview the template">
								<a href="email5.html" target="_blank">&nbsp;</a>
							</li>
						</ul>
					</div>
					<div class="mail-template">
						...
						<ul class="list-unstyled">
							<li class="color-black tooltips" data-original-title="Click to preview the template">
								<a href="email6.html" target="_blank">&nbsp;</a>
							</li>
						</ul>
					</div>
					<!--end col-md-9-->
...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/layout_email.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:46:28 GMT -->
</html>