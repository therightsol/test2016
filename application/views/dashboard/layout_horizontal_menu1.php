...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/layout_horizontal_menu1.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:45:33 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Save a soul | Layouts - Horizontal Menu 1</title>
	...
	<div class="header-inner">
		...
		<div class="hor-menu hidden-sm hidden-xs">
			<ul class="nav navbar-nav">
				...
				<li>
					<a data-toggle="dropdown" data-hover="dropdown" data-close-others="true" class="dropdown-toggle" href="#">Extra <i class="fa fa-angle-down"></i>
					</a>
					<ul class="dropdown-menu">
						<li>
