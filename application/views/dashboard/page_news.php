...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/page_news.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:49:50 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Save a soul | Pages - News</title>
					...
					<div class="row">
						<div class="col-md-5">
							<div id="myCarousel" class="carousel image-carousel slide">
								<div class="carousel-inner">
									<div class="active item">
										<img src="assets/img/gallery/image5.jpg" class="img-responsive" alt="">
									...
									<div class="item">
										<img src="assets/img/gallery/image2.jpg" class="img-responsive" alt="">
										<div class="carousel-caption">
									...
									<div class="item">
										<img src="assets/img/gallery/image1.jpg" class="img-responsive" alt="">
										<div class="carousel-caption">
							...
							<div class="news-blocks">
								...
								<p>
									<img class="news-block-img pull-right" src="assets/img/gallery/image1.jpg" alt="">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident
								</p>
							...
							<div class="news-blocks">
								...
								<p>
									<img class="news-block-img pull-right" src="assets/img/gallery/image4.jpg" alt="">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident
								</p>
								<a href="page_news_item.html" class="news-block-btn">
								Read more <i class="m-icon-swapright m-icon-black"></i>
								</a>
							...
							<div class="news-blocks">
								...
								<p>
									<img class="news-block-img pull-right" src="assets/img/gallery/image5.jpg" alt="">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident
								</p>
								<a href="page_news_item.html" class="news-block-btn">
								Read more <i class="m-icon-swapright m-icon-black"></i>
								</a>
						...
						<div class="col-md-4">
							...
							<div class="news-blocks">
								...
								<p>
									<img class="news-block-img pull-right" src="assets/img/gallery/image3.jpg" alt="">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident
								</p>
								<a href="page_news_item.html" class="news-block-btn">
								Read more <i class="m-icon-swapright m-icon-black"></i>
								</a>
							...
							<div class="news-blocks">
								...
								<p>
									<img class="news-block-img pull-right" src="assets/img/gallery/image3.jpg" alt="">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint non provident
								</p>
								<a href="page_news_item.html" class="news-block-btn">
								Read more <i class="m-icon-swapright m-icon-black"></i>
								</a>
						...
						<div class="col-md-3">
							...
							<div class="news-blocks">
								...
								<p>
									<img class="news-block-img pull-right" src="assets/img/gallery/image2.jpg" alt="">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident
								</p>
								<a href="page_news_item.html" class="news-block-btn">
								Read more <i class="m-icon-swapright m-icon-black"></i>
								</a>
							...
							<div class="row">
								<div class="col-md-12">
									<div class="news-blocks">
										...
										<p>
											<img class="news-block-img pull-right" src="assets/img/gallery/image2.jpg" alt="">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident iti..
										</p>
										<a href="page_news_item.html" class="news-block-btn">
										Read more <i class="m-icon-swapright m-icon-black"></i>
										</a>
...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/page_news.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:49:51 GMT -->
</html>