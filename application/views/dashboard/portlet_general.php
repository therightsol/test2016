...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/portlet_general.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:51:14 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Save a soul | Portlets - General Portlets</title>
			...
			<div class="row">
					...
					<div class="portlet box grey">
						<div class="portlet-title">
							...
							<div class="actions">
								...
								<a href="#" class="btn green btn-sm"><i class="fa fa-plus"></i> Add</a>
							</div>
						</div>
				...
				<div class="col-md-4 ">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Portlet2
							</div>
							<div class="tools">
							...
							<div class="actions">
								<a href="#" class="btn blue btn-sm"><i class="fa fa-pencil"></i> Edit</a>
							</div>
						</div>
						<div class="portlet-body">
				...
				<div class="col-md-4 ">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Portlet3
							</div>
							<div class="actions">
								<a href="#" class="btn blue"><i class="fa fa-pencil"></i> Edit</a>
								<div class="btn-group">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Nestable Portlets
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="#portlet-config" data-toggle="modal" class="config"></a>
								...
								<div class="col-md-6">
									...
									<div class="portlet solid grey">
										<div class="portlet-title">
											...
											<div class="actions">
												<a href="#" class="btn default btn-sm"><i class="fa fa-pencil icon-black"></i> Edit</a>
												<div class="btn-group">
				...
				<div class="col-md-6 ">
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							...
							<div class="actions">
								<a href="#" class="btn yellow"><i class="fa fa-pencil"></i> Edit</a>
				...
				<div class="col-md-4">
					...
					<div class="portlet">
						<div class="portlet-title">
							...
							<div class="actions">
								<a href="#" class="btn default btn-sm"><i class="fa fa-share icon-black"></i> Share</a>
								<div class="btn-group">
									<a class="btn btn-sm red" href="#" data-toggle="dropdown">
									<i class="fa fa-user"></i> User <i class="fa fa-angle-down "></i>
									</a>
				...
				<div class="col-md-8">
					...
					<div class="portlet">
						<div class="portlet-title">
							...
							<div class="actions">
								<a href="#" class="btn blue btn-sm"><i class="fa fa-share"></i> Share</a>
								<div class="btn-group">
