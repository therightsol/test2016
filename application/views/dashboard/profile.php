...
<!-- BEGIN HEADER -->
<?php include 'includes/top_nav.inc'; ?>
<!-- BEGIN CONTAINER -->
<div class="page-container">
	<!-- BEGIN SIDEBAR -->
	<?php include 'includes/side_nav.inc'; ?>
	<!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
								...
								<div class="row">
									<div class="col-md-3">
										<ul class="list-unstyled profile-nav">
											<li>
												<img src="<?php echo $root; ?>admin_assets/img/profile/profile-img.png" class="img-responsive" alt=""/>
							...
							<div class="tab-pane" id="tab_1_4">
								...
								<div class="row portfolio-block">
									<div class="col-md-5">
										<div class="portfolio-text">
											<img src="<?php echo $root; ?>admin_assets/img/profile/portfolio/logo_metronic.jpg" alt=""/>
											<div class="portfolio-text-info">
												<h4>Save a soul - Responsive Template</h4>
												<p>
								...
								<div class="row portfolio-block">
									<div class="col-md-5 col-sm-12 portfolio-text">
										<img src="<?php echo $root; ?>admin_assets/img/profile/portfolio/logo_azteca.jpg" alt=""/>
										<div class="portfolio-text-info">
											<h4>Save a soul - Responsive Template</h4>
											<p>
												Lorem ipsum dolor sit consectetuer adipiscing elit.
								...
								<div class="row portfolio-block">
									<div class="col-md-5 portfolio-text">
										<img src="<?php echo $root; ?>admin_assets/img/profile/portfolio/logo_conquer.jpg" alt=""/>
										<div class="portfolio-text-info">
											<h4>Save a soul - Responsive Template</h4>
											<p>
												Lorem ipsum dolor sit consectetuer adipiscing elit.
