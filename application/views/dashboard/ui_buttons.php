<!DOCTYPE html>
<!-- 
Template Name: Save a soul - Responsive Admin Dashboard Template build with Twitter Bootstrap 3.0.3
Version: 1.5.5
Author: KeenThemes
...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/ui_buttons.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:46:32 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Save a soul | UI Features - Buttons & Icons</title>
...
<div class="page-container">
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Buttons & Icons <small>buttons, icons, button dropdowns and more</small>
					</h3>
			...
			<div class="row">
				<div class="col-md-6">
					...
					<div class="portlet box green ">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Buttons
							</div>
							<div class="tools">
						...
						<div class="portlet-body util-btn-margin-bottom-5">
							...
							<div class="clearfix">
								<h4 class="block">Save a soul Style Buttons</h4>
							...
							<div class="tabbable portlet-tabs">
								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="dropdown_glyphicon">
										<div class="clearfix">
											<h4 class="block">Large Buttons with Font Awesome Icons</h4>
											<a href="#" class="btn btn-lg default">Default
											<span class="glyphicon glyphicon-cog">
											</span>
											</a>
											<a href="#" class="btn btn-lg red">Red
											...
											<span class="glyphicon glyphicon-font">
											 ...
											 Blue</a>
											<a href="#" class="btn btn-lg green">Green
											<span class="glyphicon glyphicon-gift">
											</span>
											</a>
											<a href="#" class="btn btn-lg yellow">Yellow
											...
											<a href="#" class="btn btn-lg dark">Dark
										...
										<div class="clearfix">
											<h4 class="block">Default Buttons with Font Awesome Icons</h4>
											<a href="#" class="btn default">Default
											<span class="glyphicon glyphicon-cog">
											</span>
											</a>
											<a href="#" class="btn red">Red
											<span class="glyphicon glyphicon-calendar">
											</span>
											</a>
											...
											<span class="glyphicon glyphicon-font">
											 ...
											 Blue</a>
											<a href="#" class="btn green">Green
											<span class="glyphicon glyphicon-gift">
											</span>
											</a>
											<a href="#" class="btn yellow">Yellow
											<span class="glyphicon glyphicon-pencil">
											</span>
											</a>
										...
										<div class="clearfix">
											<h4 class="block">Small Buttons with Font Awesome Icons</h4>
											<a href="#" class="btn btn-sm default">Default
											<span class="glyphicon glyphicon-cog">
											</span>
											</a>
											<a href="#" class="btn btn-sm red">Red
											<span class="glyphicon glyphicon-calendar">
											</span>
											</a>
											...
											<span class="glyphicon glyphicon-font">
											 ...
											 Blue</a>
											<a href="#" class="btn btn-sm green">Green
											<span class="glyphicon glyphicon-gift">
											</span>
											</a>
											<a href="#" class="btn btn-sm yellow">Yellow
											<span class="glyphicon glyphicon-pencil">
											</span>
											</a>
											...
											<a href="#" class="btn btn-sm dark">Dark
											<span class="glyphicon glyphicon-link">
											</span>
											</a>
										</div>
										<div class="clearfix">
											<h4 class="block">Extra Small Buttons with Font Awesome Icons</h4>
											<a href="#" class="btn btn-xs default">Default
											<span class="glyphicon glyphicon-cog">
											</span>
											</a>
											<a href="#" class="btn btn-xs red">Red
											<span class="glyphicon glyphicon-calendar">
											</span>
											</a>
											...
											<span class="glyphicon glyphicon-font">
											 ...
											 Blue</a>
											<a href="#" class="btn btn-xs green">Green
											<span class="glyphicon glyphicon-gift">
											</span>
											</a>
											<a href="#" class="btn btn-xs yellow">Yellow
											<span class="glyphicon glyphicon-pencil">
											</span>
											</a>
											...
											<a href="#" class="btn btn-xs dark">Dark
											<span class="glyphicon glyphicon-link">
											</span>
											</a>
										</div>
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Font Awesome Styled Buttons
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="#portlet-config" data-toggle="modal" class="config"></a>
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>List Social Icons(UL)
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="#portlet-config" data-toggle="modal" class="config"></a>
						...
						<div class="portlet-body util-btn-margin-bottom-5">
							<ul class="social-icons">
								<li>
									<a href="#" data-original-title="amazon" class="amazon"></a>
								</li>
								<li>
									<a href="#" data-original-title="behance" class="behance"></a>
								</li>
								<li>
									<a href="#" data-original-title="blogger" class="blogger"></a>
								</li>
								<li>
									<a href="#" data-original-title="deviantart" class="deviantart"></a>
								</li>
								<li>
									<a href="#" data-original-title="dribbble" class="dribbble"></a>
								</li>
								<li>
									<a href="#" data-original-title="dropbox" class="dropbox"></a>
								</li>
								<li>
									<a href="#" data-original-title="facebook" class="facebook"></a>
								</li>
								<li>
									<a href="#" data-original-title="forrst" class="forrst"></a>
								</li>
								<li>
								...
								<li>
									<a href="#" data-original-title="jolicloud" class="jolicloud"></a>
								</li>
								<li>
									<a href="#" data-original-title="last-fm" class="last-fm"></a>
								</li>
								<li>
									<a href="#" data-original-title="linkedin" class="linkedin"></a>
								</li>
								<li>
									<a href="#" data-original-title="picasa" class="picasa"></a>
								</li>
								<li>
									<a href="#" data-original-title="pintrest" class="pintrest"></a>
								</li>
								<li>
								...
								<li>
									<a href="#" data-original-title="spotify" class="spotify"></a>
								</li>
								<li>
									<a href="#" data-original-title="stumbleupon" class="stumbleupon"></a>
								</li>
								<li>
									<a href="#" data-original-title="tumblr" class="tumblr"></a>
								</li>
								<li>
								...
								<li>
									<a href="#" data-original-title="wordpress" class="wordpress"></a>
								</li>
								<li>
									<a href="#" data-original-title="xing" class="xing"></a>
								</li>
								<li>
								...
								<li>
									<a href="#" data-original-title="vk" class="vk"></a>
								</li>
								<li>
									<a href="#" data-original-title="instagram" class="instagram"></a>
								</li>
								<li>
									<a href="#" data-original-title="reddit" class="reddit"></a>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Inline Social Icons
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="#portlet-config" data-toggle="modal" class="config"></a>
						...
						<div class="portlet-body util-btn-margin-bottom-5">
							<a href="#" data-original-title="amazon" class="social-icon amazon"></a>
							<a href="#" data-original-title="behance" class="social-icon behance"></a>
							<a href="#" data-original-title="blogger" class="social-icon blogger"></a>
							<a href="#" data-original-title="deviantart" class="social-icon deviantart"></a>
							<a href="#" data-original-title="dribbble" class="social-icon dribbble"></a>
							...
							<a href="#" data-original-title="forrst" class="social-icon forrst"></a>
							<a href="#" data-original-title="github" class="social-icon github"></a>
							<a href="#" data-original-title="Goole Plus" class="social-icon googleplus"></a>
							<a href="#" data-original-title="jolicloud" class="social-icon jolicloud"></a>
							<a href="#" data-original-title="last-fm" class="social-icon last-fm"></a>
							<a href="#" data-original-title="linkedin" class="social-icon linkedin"></a>
							<a href="#" data-original-title="picasa" class="social-icon picasa"></a>
							<a href="#" data-original-title="pintrest" class="social-icon pintrest"></a>
							<a href="#" data-original-title="rss" class="social-icon rss"></a>
							<a href="#" data-original-title="skype" class="social-icon skype"></a>
							<a href="#" data-original-title="spotify" class="social-icon spotify"></a>
							<a href="#" data-original-title="stumbleupon" class="social-icon stumbleupon"></a>
							<a href="#" data-original-title="tumblr" class="social-icon tumblr"></a>
							<a href="#" data-original-title="twitter" class="social-icon twitter"></a>
							<a href="#" data-original-title="vimeo" class="social-icon vimeo"></a>
							<a href="#" data-original-title="wordpress" class="social-icon wordpress"></a>
							<a href="#" data-original-title="xing" class="social-icon xing"></a>
							<a href="#" data-original-title="yahoo" class="social-icon yahoo"></a>
							<a href="#" data-original-title="youtube" class="social-icon youtube"></a>
							<a href="#" data-original-title="vk" class="social-icon vk"></a>
							<a href="#" data-original-title="instagram" class="social-icon instagram"></a>
							<a href="#" data-original-title="reddit" class="social-icon reddit"></a>
						</div>
					</div>
					<!-- END BLOCK BUTTONS PORTLET-->
					<!-- BEGIN BLOCK BUTTONS PORTLET-->
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Social Icons(Colored)
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="#portlet-config" data-toggle="modal" class="config"></a>
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Inline Social Icons(Colored)
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="#portlet-config" data-toggle="modal" class="config"></a>
						...
						<div class="portlet-body util-btn-margin-bottom-5">
							<a href="#" data-original-title="amazon" class="social-icon social-icon-color amazon"></a>
							<a href="#" data-original-title="behance" class="social-icon social-icon-color behance"></a>
							<a href="#" data-original-title="blogger" class="social-icon social-icon-color blogger"></a>
							<a href="#" data-original-title="deviantart" class="social-icon social-icon-color deviantart"></a>
							<a href="#" data-original-title="dribbble" class="social-icon social-icon-color dribbble"></a>
							<a href="#" data-original-title="dropbox" class="social-icon social-icon-color dropbox"></a>
							<a href="#" data-original-title="facebook" class="social-icon social-icon-color facebook"></a>
							<a href="#" data-original-title="forrst" class="social-icon social-icon-color forrst"></a>
							<a href="#" data-original-title="github" class="social-icon social-icon-color github"></a>
							<a href="#" data-original-title="Goole Plus" class="social-icon social-icon-color googleplus"></a>
							<a href="#" data-original-title="jolicloud" class="social-icon social-icon-color jolicloud"></a>
							<a href="#" data-original-title="last-fm" class="social-icon social-icon-color last-fm"></a>
							<a href="#" data-original-title="linkedin" class="social-icon social-icon-color linkedin"></a>
							<a href="#" data-original-title="picasa" class="social-icon social-icon-color picasa"></a>
							<a href="#" data-original-title="pintrest" class="social-icon social-icon-color pintrest"></a>
							<a href="#" data-original-title="rss" class="social-icon social-icon-color rss"></a>
							<a href="#" data-original-title="skype" class="social-icon social-icon-color skype"></a>
							<a href="#" data-original-title="spotify" class="social-icon social-icon-color spotify"></a>
							<a href="#" data-original-title="stumbleupon" class="social-icon social-icon-color stumbleupon"></a>
							<a href="#" data-original-title="tumblr" class="social-icon social-icon-color tumblr"></a>
							<a href="#" data-original-title="twitter" class="social-icon social-icon-color twitter"></a>
							<a href="#" data-original-title="vimeo" class="social-icon social-icon-color vimeo"></a>
							<a href="#" data-original-title="wordpress" class="social-icon social-icon-color wordpress"></a>
							<a href="#" data-original-title="xing" class="social-icon social-icon-color xing"></a>
							<a href="#" data-original-title="yahoo" class="social-icon social-icon-color yahoo"></a>
							<a href="#" data-original-title="youtube" class="social-icon social-icon-color youtube"></a>
							<a href="#" data-original-title="vk" class="social-icon social-icon-color vk"></a>
							<a href="#" data-original-title="instagram" class="social-icon social-icon-color instagram"></a>
							<a href="#" data-original-title="reddit" class="social-icon social-icon-color reddit"></a>
						</div>
					</div>
					<!-- END BLOCK BUTTONS PORTLET-->
				</div>
				<div class="col-md-6">
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Button Groups
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
								<a href="#portlet-config" data-toggle="modal" class="config"></a>
					...
					<div class="portlet box blue tabbable hide">
						...
						<div class="portlet-body form">
							<div class="tabbable portlet-tabs">
								<ul class="nav nav-tabs">
									<li>
										<a href="#dropdown_2" data-toggle="tab">Hoverable</a>
									</li>
									<li class="active">
										<a href="#dropdown_1" data-toggle="tab">Default</a>
									</li>
								</ul>
								<div class="tab-content">
										...
										<div class="btn-toolbar">
											...
											<div class="btn-group">
												...
												<ul class="dropdown-menu">
													...
													<li>
														<a href="#"><i class="fa fa-trash-o"></i> Edit</a>
													</li>
													<li>
													...
													<li>
														<a href="#"><i class="i"></i> Full Settings</a>
													</li>
												</ul>
											</div>
										</div>
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i> Button Dropdowns
							</div>
						</div>
						<div class="portlet-body util-btn-group-margin-bottom-5">
							...
							<div class="clearfix">
								<h4 class="block">Save a soul Style</h4>
								<div class="btn-group">
									<button type="button" class="btn default">Default</button>
										...
										<li class="dropdown-submenu">
											...
											<ul class="dropdown-menu" style="">
												...
												<li class="dropdown-submenu">
													...
													<ul class="dropdown-menu">
														<li>
															<a href="index-2.html">Third level link</a>
														</li>
														<li>
															<a href="index-2.html">Third level link</a>
														</li>
												...
												<li>
													<a href="index-2.html">Second level link</a>
												</li>
												<li>
													<a href="index-2.html">Second level link</a>
												</li>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="tabbable tabbable-custom">
						<ul class="nav nav-tabs">
							<li class="active">
								<a href="#tab_1_1" data-toggle="tab">Font Awesome Icons</a>
							</li>
							<li>
						...
						<div class="tab-content">
							<div class="tab-pane active fontawesome-demo" id="tab_1_1">
								<div class="note note-success">
									<p>
										 Font Awesome gives you scalable vector icons that can instantly be customized — size, color, drop shadow, and anything that can be done with the power of CSS. The complete set of 370 icons in Font Awesome 4.0.1
									</p>
								</div>
								...
								<div class="row margin-bottom-20">
									...
									<div class="fa-item col-md-3 col-sm-4">
										<i class="fa fa-times"></i> fa-clock-o"s
									</div>
									<div class="fa-item col-md-3 col-sm-4">
										<i class="fa fa-clock-o" s-circle"></i> fa-clock-o"s-circle
									</div>
									<div class="fa-item col-md-3 col-sm-4">
										<i class="fa fa-clock-o" s-circle-o"></i> fa-clock-o"s-circle-o
									</div>
									<div class="fa-item col-md-3 col-sm-4">
							...
							<div class="tab-pane glyphicons-demo" id="tab_1_2">
								...
								<ul class="list-unstyled1">
									...
									<li>
										<span class="glyphicon glyphfa-ban">
										</span>
										 .glyphicon .glyphfa-ban
									</li>
									<li>
									...
									<li>
										<span class="glyphicon glyphfa fa-clock-o" s"">
										</span>
										 .glyphicon .glyphfa fa-clock-o"s"
									</li>
									<li>
										<span class="glyphicon glyphfa fa-clock-o" s"-circle">
										</span>
										 .glyphicon .glyphfa fa-clock-o"s"-circle
									</li>
									<li>
										<span class="glyphicon glyphfa fa-clock-o" s"-sign">
										</span>
										 .glyphicon .glyphfa fa-clock-o"s"-sign
									</li>
									<li>
	...
	<div class="footer">
		<div class="footer-inner">
			 2013 &copy; Save a soul by keenthemes.
		</div>
...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/ui_buttons.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:46:33 GMT -->
</html>