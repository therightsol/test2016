...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/ui_extended_modals.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:46:35 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Save a soul | UI Features - Extended Modals</title>
...
<div class="page-container">
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<h3 class="page-title">
			Extended Modals <small>extended bootstrap modals</small>
			</h3>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="note note-success">
						...
						<p>
							 Extends Bootstrap's native modals to provide additional functionality. Introduces a ModalManager class that operates behind the scenes to handle multiple modals by listening on their events. Go ahead to check out <a href="https://github.com/jschr/bootstrap-modal" target="_blank">the official home</a> of the Extended Modals Plugin.
						</p>
					</div>
					<!-- BEGIN PORTLET-->
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Extended Modals Example
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<td>
									<a class="btn default" data-target="#stack1" data-toggle="modal">View Demo</a>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<a class="btn default" data-target="#static2" data-toggle="modal">View Demo</a>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<a class="btn default" data-target="#static" data-toggle="modal">View Demo</a>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<a class="btn default" data-target="#full-width" data-toggle="modal">View Demo</a>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<a class="btn default" data-target="#long" data-toggle="modal">View Demo</a>
								</td>
							</tr>
							</table>
							<!-- responsive -->
							...
							<div id="long" class="modal fade modal-scroll" tabindex="-1" data-replace="true">
								...
								<div class="modal-body">
									<img style="height: 800px" src="../../../i.imgur.com/KwPYo.jpg">
								</div>
								<div class="modal-footer">
									<button type="button" data-dismiss="modal" class="btn btn-default">Close</button>
								</div>
...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/ui_extended_modals.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:46:40 GMT -->
</html>