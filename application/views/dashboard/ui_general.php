...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/ui_general.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:46:29 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Save a soul | UI Features - General</title>
				...
				<div class="col-md-6">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<div class="alert alert-block alert-success fade in">
								...
								<p>
									<a class="btn green" href="#">Do this</a>
							...
							<div class="alert alert-block alert-info fade in">
								...
								<p>
									<a class="btn purple" href="#">Do this</a>
									<a class="btn dark" href="#">Cancel</a>
								</p>
							</div>
					...
					<div class="portlet box green">
						...
						<div class="portlet-body util-btn-margin-bottom-5">
							...
							<a href="javascript:;" class="btn default" id="gritter-regular">Regular</a>
							<a href="javascript:;" class="btn default" id="gritter-sticky">Sticky</a>
							<a href="javascript:;" class="btn default" id="gritter-without-image">Imageless</a>
							<a href="javascript:;" class="btn default" id="gritter-light">Light</a>
							<a href="javascript:;" class="btn default" id="gritter-max">Max of 3</a>
							<a href="javascript:;" class="btn red" id="gritter-remove-all">Remove all</a>
						</div>
					</div>
					...
					<div class="portlet box red">
						...
						<div class="portlet-body">
							<p>
								 Tight pants next level keffiyeh <a href="#" class="tooltips" data-original-title="Very long toolips Very long toolips Very long toolips Very long toolips">you probably</a> haven't heard of them. Photo booth beard raw denim letterpress vegan messenger bag stumptown. Farm-to-table seitan, mcsweeney's fixie sustainable quinoa 8-bit american apparel <a href="#" class="tooltips" data-original-title="Another tooltip">have a</a> terry richardson vinyl chambray. <a href="#" class="tooltips" title="12" data-original-title="The last tip!">twitter handle</a> freegan cred raw denim single-origin coffee viral.
							</p>
							<p>
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							<div class="scroller" style="height:150px" data-always-visible="1" data-rail-visible="0">
								...
								<p>
									 Tight pants next level keffiyeh <a href="#" class="tooltips" data-container="body" data-original-title="Default tooltip">you probably</a> haven't heard of them. Photo booth beard raw denim letterpress vegan messenger bag stumptown. Farm-to-table seitan, mcsweeney's fixie sustainable quinoa 8-bit american apparel <a href="#" class="tooltips" data-container="body" data-original-title="Another tooltip">have a</a> terry richardson vinyl chambray. <a href="#" class="tooltips" title="12" data-container="body" data-original-title="The last tip!">twitter handle</a> freegan cred raw denim single-origin coffee viral.
								</p>
								<p>
									<button class="btn tooltips" data-container="body" data-placement="top" data-original-title="Tooltip in top">Top</button>
									<button class="btn tooltips" data-container="body" data-placement="left" data-original-title="Tooltip in left">Left</button>
				...
				<div class="col-md-6">
							...
							<div class="clearfix">
								...
								<div class="dropdown inline clearfix">
									...
									<ul class="dropdown-menu" role="menu">
										...
										<li role="presentation">
											<a role="menuitem" tabindex="-1" href="#">Something here
											<span class="badge badge-danger">
												7
											</span>
											</a>
					...
					<div class="portlet box yellow">
						...
						<div class="portlet-body">
							...
							<ul class="pager">
								<li class="previous">
									<a href="#" class="btn blue"><i class="fa fa-angle-left"></i> Older</a>
								</li>
								<li class="next">
									<a href="#" class="btn blue">Newer <i class="fa fa-angle-right"></i></a>
								</li>
							</ul>
						</div>
					</div>
							...
							<div class="clearfix">
								<ul class="media-list">
									<li class="media">
										...
										<img class="media-object" src="holder.js/64x64.html" alt="">
										</a>
						...
						<div class="portlet-body">
							...
							<div class="row">
								<div class="col-sm-6 col-md-3">
									...
									<img src="holder.js/100%25x180.html" alt="100%x180" style="height: 180px; width: 100%; display: block;">
									</a>
								</div>
								<div class="col-sm-6 col-md-3">
									<a href="#" class="thumbnail">
							...
							<div class="row">
								<div class="col-sm-12 col-md-6">
									<div class="thumbnail">
										<img src="holder.js/100%25x200.html" alt="" style="width: 100%; height: 200px;">
										<div class="caption">
...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/ui_general.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:46:32 GMT -->
</html>