...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/ui_modals.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:46:33 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Save a soul | UI Features - Modals</title>
	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					<h3 class="page-title">
					Modals <small>modals samples</small>
					</h3>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="note note-success">
						...
						<p>
							 Modals are streamlined, but flexible, dialog prompts with the minimum required functionality and smart defaults. If you need more control over the Bootstrap Modals please check out <a href="ui_extended_modals.html">extended modals</a>.
						</p>
					</div>
					<!-- BEGIN PORTLET-->
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Static Example
							</div>
							<div class="tools">
						...
						<div class="portlet-body">
							...
							<tr>
								...
								<td>
									<a class="btn default" data-toggle="modal" href="#wide">View Demo</a>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<a class="btn default" data-toggle="modal" href="#full">View Demo</a>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<a class=" btn default" href="ui_modals_ajax_sample.html" data-target="#ajax" data-toggle="modal">View Demo</a>
								</td>
							</tr>
							<tr>
								<td>
							...
							<tr>
								...
								<td>
									<a class=" btn default" data-toggle="modal" href="#static">View Demo</a>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<a class=" btn default" data-toggle="modal" href="#long">View Demo</a>
								</td>
							</tr>
							</table>
							...
							<div id="long" class="modal fade modal-scroll" tabindex="-1" data-replace="true">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body">
											<img style="height: 800px" alt="" src="../../../i.imgur.com/KwPYo.jpg">
										</div>
										<div class="modal-footer">
											<button type="button" data-dismiss="modal" class="btn">Close</button>
										</div>
...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/ui_modals.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:46:35 GMT -->
</html>