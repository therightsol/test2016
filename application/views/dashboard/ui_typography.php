...
<!-- Mirrored from www.keenthemes.com/preview/metronic_admin/ui_typography.html by HTTrack Website Copier/3.x [XR&CO'2013], Wed, 18 Dec 2013 10:46:33 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
<meta charset="utf-8"/>
<title>Save a soul | UI Features - Typography</title>
		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<h3 class="page-title">
					Typography <small>texts, headings, lists and more</small>
					</h3>
			...
			<div class="row">
				<div class="col-md-8">
					...
					<div>
						...
						<div class="portlet">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-reorder"></i>Blockquotes
								</div>
								<div class="tools">
									<a href="javascript:;" class="collapse"></a>
									<a href="#portlet-config" data-toggle="modal" class="config"></a>
					...
					<div>
						<div class="portlet">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-reorder"></i>Alignments
								</div>
								<div class="tools">
									<a href="javascript:;" class="collapse"></a>
									<a href="#portlet-config" data-toggle="modal" class="config"></a>
				...
				<div class="col-md-4">
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Unordered Lists
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
							</div>
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Ordered Lists
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
							</div>
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Unstyled Lists
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
							</div>
					...
					<div class="portlet box red">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Inline List
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
							</div>
					...
					<div class="portlet box purple">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Description Lists
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
							</div>
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-reorder"></i>Text States
							</div>
							<div class="tools">
								<a href="javascript:;" class="collapse"></a>
							</div>
