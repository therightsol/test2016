                ...
                <div class="column cause-column col-md-3 col-sm-6 col-xs-12" >
                	...
                	<article class="inner-box text-center hvr-bounce-in" style="height:500px;">
                		<figure class="image-box">
                        	<a href="#"><img src="<?php echo $value['donation_image_path']; ?>" alt=""></a>
                        ...
                        <div class="content-box">
                            ...
                            <a href="<?php echo $root; ?>Donation_update/update/<?php echo $value['donation_id']; ?>" class="theme-btn btn-style-two" style=";color:#eb5310 !important">Update</a>
                            <br />
                            <br />
                            <a href="<?php echo $root; ?>Donation_update/delete_donation/<?php echo $value['donation_id']; ?>" class="theme-btn btn-style-two" style=";color:#eb5310 !important"> Delete</a>
                        </div>
                    </article>
                </div>
                <?php }else{
