...
<div class="page-wrapper">
                            ...
                            <ul class="navigation">
                                ...
                                <li class="dropdown"><a href="volunteers.html">Pages</a>
                                    <ul class="submenu-dropdown">
                                        ...
                                        <li class="current dropdown"><a href="event-two-column.html">Events</a>
                                            <ul class="submenu-dropdown">
    ...
    <section class="page-title" style="background-image:url(images/background/page-title-bg.jpg);">
    	<div class="auto-container">
        	<div class="sec-title">
                <h1>Upcoming <span class="normal-font">Events</span></h1>
    	...
    	<div class="auto-container">
        	<div class="row clearfix">
                ...
                <div class="col-lg-9 col-md-8 col-sm-12 col-xs-12">
                    ...
                    <!--Events Section-->
                    <section class="events-section upcoming-events no-padd-top no-padd-bottom">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="column event-column col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <article class="inner-box">
                                    <figure class="image-box">
                                        <a href="#"><img src="images/resource/featured-image-18.jpg" alt=""></a>
                                    </figure>
                            ...
                            <div class="column event-column col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <article class="inner-box">
                                    <figure class="image-box">
                                        <a href="#"><img src="images/resource/featured-image-20.jpg" alt=""></a>
                                    </figure>
                                    <div class="content-box">
                                        <h3><a href="#">Clean Water for Children</a></h3>
                                        <div class="event-info">13-14 Feb in Sanfransico, CA</div>
                            ...
                            <div class="column event-column col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <article class="inner-box">
                                    <figure class="image-box">
                                        <a href="#"><img src="images/resource/featured-image-21.jpg" alt=""></a>
                                    </figure>
                                    <div class="content-box">
                                        <h3><a href="#">Clean Water for Children</a></h3>
                                        <div class="event-info">13-14 Feb in Sanfransico, CA</div>
                            ...
                            <div class="column event-column col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <article class="inner-box">
                                    <figure class="image-box">
                                        <a href="#"><img src="images/resource/featured-image-22.jpg" alt=""></a>
                                    </figure>
                                    <div class="content-box">
                                        <h3><a href="#">Clean Water for Children</a></h3>
                                        <div class="event-info">13-14 Feb in Sanfransico, CA</div>
                            ...
                            <div class="column event-column col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <article class="inner-box">
                                    <figure class="image-box">
                                        <a href="#"><img src="images/resource/featured-image-23.jpg" alt=""></a>
                                    </figure>
                                    <div class="content-box">
                                        <h3><a href="#">Clean Water for Children</a></h3>
                                        <div class="event-info">13-14 Feb in Sanfransico, CA</div>
