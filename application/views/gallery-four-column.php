                    ...
                    <nav class="main-menu">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation">
                                ...
                                <li class="dropdown"><a href="causes-grid.html">Cause</a>
                                ...
                                <li class="current dropdown"><a href="gallery-fullwidth.html">Gallery</a>
                                    <ul class="submenu-dropdown">
    ...
    <section class="page-title" style="background-image:url(images/background/page-title-bg.jpg);">
    	<div class="auto-container">
        	<div class="sec-title">
                ...
                <div class="bread-crumb"><a href="#">Home</a> / <a href="#" class="current">Gallery</a></div>
            </div>
        </div>
    </section>
    ...
    <section class="gallery-section">
        ...
        <div class="auto-container images-container">
            <div class="filter-list clearfix">
                ...
                <!--Image Box-->
                <div class="image-box mix mix_all volunteer donate col-lg-3 col-md-4 col-xs-12">
                    <div class="inner-box">
                        <figure class="image"><a href="images/gallery/image-9.jpg" class="lightbox-image"><img src="images/gallery/image-9.jpg" alt=""></a></figure>
                        <a href="images/gallery/image-9.jpg" class="zoom-btn lightbox-image"><span class="icon flaticon-cross"></span></a>
                    </div>
                </div>
                
                <!--Image Box-->
                <div class="image-box mix mix_all children donate col-lg-3 col-md-4 col-xs-12">
                    <div class="inner-box">
                        <figure class="image"><a href="images/gallery/image-10.jpg" class="lightbox-image"><img src="images/gallery/image-10.jpg" alt=""></a></figure>
                        <a href="images/gallery/image-10.jpg" class="zoom-btn lightbox-image"><span class="icon flaticon-cross"></span></a>
                    </div>
                </div>
                
                <!--Image Box-->
                <div class="image-box mix mix_all children volunteer col-lg-3 col-md-4 col-xs-12">
                    <div class="inner-box">
                        <figure class="image"><a href="images/gallery/image-11.jpg" class="lightbox-image"><img src="images/gallery/image-11.jpg" alt=""></a></figure>
                        <a href="images/gallery/image-11.jpg" class="zoom-btn lightbox-image"><span class="icon flaticon-cross"></span></a>
                    </div>
                </div>
                
                <!--Image Box-->
                <div class="image-box mix mix_all children volunteer donate col-lg-3 col-md-4 col-xs-12">
                    <div class="inner-box">
                        <figure class="image"><a href="images/gallery/image-12.jpg" class="lightbox-image"><img src="images/gallery/image-12.jpg" alt=""></a></figure>
                        <a href="images/gallery/image-12.jpg" class="zoom-btn lightbox-image"><span class="icon flaticon-cross"></span></a>
                    </div>
                </div>
                ...
                <div class="image-box mix mix_all children volunteer  col-lg-3 col-md-4 col-xs-12">
                    <div class="inner-box">
                        <figure class="image"><a href="images/gallery/image-13.jpg" class="lightbox-image"><img src="images/gallery/image-13.jpg" alt=""></a></figure>
                        <a href="images/gallery/image-13.jpg" class="zoom-btn lightbox-image"><span class="icon flaticon-cross"></span></a>
                    </div>
                </div>
                ...
                <div class="image-box mix mix_all volunteer donate col-lg-3 col-md-4 col-xs-12">
                    <div class="inner-box">
                        <figure class="image"><a href="images/gallery/image-14.jpg" class="lightbox-image"><img src="images/gallery/image-14.jpg" alt=""></a></figure>
                        <a href="images/gallery/image-14.jpg" class="zoom-btn lightbox-image"><span class="icon flaticon-cross"></span></a>
                    </div>
                </div>
                ...
                <div class="image-box mix mix_all children volunteer  col-lg-3 col-md-4 col-xs-12">
                    <div class="inner-box">
                        <figure class="image"><a href="images/gallery/image-15.jpg" class="lightbox-image"><img src="images/gallery/image-15.jpg" alt=""></a></figure>
                        <a href="images/gallery/image-15.jpg" class="zoom-btn lightbox-image"><span class="icon flaticon-cross"></span></a>
                    </div>
                </div>
                ...
                <div class="image-box mix mix_all children volunteer  col-lg-3 col-md-4 col-xs-12">
                    <div class="inner-box">
                        <figure class="image"><a href="images/gallery/16.html" class="lightbox-image"><img src="images/gallery/image-16.jpg" alt=""></a></figure>
                        <a href="images/gallery/image-16.jpg" class="zoom-btn lightbox-image"><span class="icon flaticon-cross"></span></a>
                    </div>
                </div>
