...
<div class="page-wrapper">
                    ...
                    <nav class="main-menu">
                        ...
                        <div class="navbar-collapse collapse clearfix">
                            <ul class="navigation">
                                ...
                                <li class="current dropdown"><a href="volunteers.html">Pages</a>
                                    <ul class="submenu-dropdown">
    ...
    <section class="page-title" style="background-image:url(images/background/page-title-bg.jpg);">
    	<div class="auto-container">
        	<div class="sec-title">
                <h1>Our <span class="normal-font">Volunteer</span></h1>
                <div class="bread-crumb"><a href="#">Home</a> / <a href="#" class="current">Our Volunteer</a></div>
            </div>
        </div>
    </section>
    ...
    <section class="team-section">
    	<div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <!--Column-->
            	<article class="column team-member col-lg-3 col-md-3 col-sm-6 col-xs-12">
